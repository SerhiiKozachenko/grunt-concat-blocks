...
module.exports = function (grunt) {
    ...
    grunt.loadNpmTasks('grunt-concat-blocks/node_modules/grunt-contrib-concat');
    ...
    function compactContent(blocks) {
        ...
        var concat = grunt.config('concat') || {},
            temp = grunt.config('concatBlocks.root');
        ...
        grunt.log.subhead('Running compactContent');
         ...
         Object.keys(blocks).forEach(function (dest) {
             ...
             //grunt.log.write('Concat task updated to :' + JSON.stringify(grunt.config.get('concat')));
    ...
    grunt.registerMultiTask('concatBlocks', 'Perform files concatenation in blocks', function () {
        ...
        files.map(grunt.file.read).forEach(function (content, i) {
            ...
            grunt.log.subhead('concatBlocks' + name + ' - ' + theFile);
        ...
        grunt.log.subhead("ending concatBlocks " + name);
    });
